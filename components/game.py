...
class Game:
    ...
    def reveal_event_to_players(self, event_description):
        for player in self.players:
            player.events.append(event_description)
    ...
    def _n0(self):
        ...
        print(f"Werewvolf {werewolf.name} tries to kill {dead}")
    ...
    def _n2(self):
        ...
        if self.night_dead == saved:
            ...
            print(f"Doctor tried to save {saved} but he wasn't sick.")
